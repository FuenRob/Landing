...
$config = array(
	'titulo_pagina' => 'Sorteo dorsales Peñalara Toptrail', // Título de la página
	'og_title' => 'Sorteo dorsales Peñalara Toptrail', // Título para compartir en redes sociales
	'og_url' => 'http://localhost/landings/', // Página para compartir en redes sociales
	'og_description' => 'Consigue tus dorsales para el Gran Trail Peñalara con Toptrail ', // Descripción para compartir en redes sociales
	...
	'facebook' => array(
		'id_app' => '140726283001261', // ID de la app de Facebook en el caso de que la landing fuera en una app
		'secret_key_app' => '4d87360d122f467a88e2c51915fe62f8', // Secrey Key de la app de Facebook
		'share_url' => 'https://www.facebook.com/toptrailonline/app/140726283001261/', // Url para compartir de Facebook terminada en "/"
		'campaign' => 'toptrail_dorsal', // para registrar una campaña en la base de datos para saber de donde vienen los usuarios (si no se usa highCO, si se usa highCO irá por el CouponsLists).
		),
	'highco' => array(
